...
# Standalone SCORM Upload Script for Content.zip
...
cat > scorm_upload_response_content.json << EOF
{
  "success": true,
  "packageName": "$PACKAGE_NAME",
...
echo "📝 Response saved to: scorm_upload_response_content.json"
echo ""
